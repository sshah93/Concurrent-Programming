...
/* the only header file which contains the necessary includes for the entire assignment */
#include "header.h"
...
void* callback_function(void* args)
{
	...
	while(1)
	{
		/* sem_wait function call on the semaphore to lock the semaphore */
...
int main(int argc, char**argv)
{
	...
	/* pthread_create return value check */
